<template>
  <div class="wrapper">
    ...
    <addDistributedHouseBody :manager="manager"></addDistributedHouseBody>
...
<script>
  ...
  import addDistributedHouseBody from '@/components/addHouse/addDistributedHouseBody'
  ...
  export default {
    ...
    components: {
      ...
      addDistributedHouseBody: addDistributedHouseBody,
      feeModal: feeModal,
      appFooter: appFooter,
